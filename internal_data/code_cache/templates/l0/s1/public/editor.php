...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	<textarea name="' . $__templater->escape($__vars['htmlName']) . '"
		...
		title="' . $__templater->filter('Rich text box', array(array('for_attr', array()),), true) . '"
	...
	<noscript>
		<textarea name="' . $__templater->escape($__vars['name']) . '" class="input" title="' . $__templater->filter('Rich text box', array(array('for_attr', array()),), true) . '">' . $__templater->escape($__vars['value']) . '</textarea>
	</noscript>
...
';
	...
	<textarea name="' . $__templater->escape($__vars['name']) . '" class="input js-editor" data-xf-init="user-mentioner" title="' . $__templater->filter('Rich text box', array(array('for_attr', array()),), true) . '" ' . $__templater->filter($__vars['attrsHtml'], array(array('raw', array()),), true) . '>' . $__templater->escape($__vars['value']) . '</textarea>
