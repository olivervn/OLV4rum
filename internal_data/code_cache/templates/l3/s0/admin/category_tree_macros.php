					...
					'html' => '
									...
									<div class="menu" data-menu="menu" aria-hidden="true">
										<div class="menu-content">
											...
											<a href="' . $__templater->fn('link', array($__vars['linkPrefix'] . '/add', null, array($__vars['parentIdKey'] => $__vars['category'][$__vars['parentIdKey']], ), ), true) . '" class="menu-linkRow">' . 'Ngang hàng' . '</a>
											<a href="' . $__templater->fn('link', array($__vars['linkPrefix'] . '/add', null, array($__vars['parentIdKey'] => $__vars['category'][$__vars['idKey']], ), ), true) . '" class="menu-linkRow">' . 'Con' . '</a>
										</div>
									</div>
								',
				);
