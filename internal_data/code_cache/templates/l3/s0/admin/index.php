...
';
	...
	<div class="blockMessage blockMessage--important blockMessage--iconic">
		<a href="' . $__templater->fn('link', array('templates/outdated', ), true) . '"> ' . 'Có những mẫu có thể đã lỗi thời. Nhấn vào đây để xem lại.' . '</a>
	</div>
';
	}
	$__finalCompiled .= '
...
';
	if ($__templater->method($__vars['xf']['visitor'], 'hasAdminPermission', array('viewLogs', )) AND $__vars['serverErrorLogs']) {
		$__finalCompiled .= '
	<div class="blockMessage blockMessage--error blockMessage--iconic">
		<a href="' . $__templater->fn('link', array('logs/server-errors', ), true) . '"> ' . 'Lỗi máy chủ đã được ghi lại. Bạn nên xem lại những điều này.' . '</a>
	</div>
';
	}
	$__finalCompiled .= '
