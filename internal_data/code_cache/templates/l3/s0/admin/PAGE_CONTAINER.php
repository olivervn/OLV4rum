...
<head>
	...
	<title>
		' . $__templater->fn('page_title', array('%s | ' . $__vars['xf']['options']['boardTitle'] . ' - ' . 'Bảng điều khiển Quản trị viên', $__vars['xf']['options']['boardTitle'] . ' - ' . 'Bảng điều khiển Quản trị viên', null)) . '
	</title>
	';
