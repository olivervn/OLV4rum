					...
					'html' => '
								...
								<div class="dataList-subRow">
									<ul class="listInline listInline--bullet">
										<li>' . 'Yêu cầu đầu tiên' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->fn('date_dynamic', array($__vars['entry']['first_request_date'], array(
				))) . '</li>
										<li>' . 'Yêu cầu cuối cùng' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->fn('date_dynamic', array($__vars['entry']['last_request_date'], array(
				))) . '</li>
									</ul>
								</div>
							',
