...
';
	...
	<div class="block">
		...
		array(
			'_type' => 'cell',
			'html' => '<a href="' . $__templater->fn('link', array('user-upgrades/expired', $__vars['userUpgrade'], array('order' => 'end_date', 'direction' => 'desc', ) + $__vars['linkParams'], ), true) . '">' . 'Ngày kết thúc' . '</a>',
		))) . '
					' . $__compilerTemp1 . '
				', array(
