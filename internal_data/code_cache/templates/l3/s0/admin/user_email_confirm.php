...
';
	if ($__vars['tested']) {
		$__finalCompiled .= '
	<div class="blockMessage blockMessage--success blockMessage--iconic">' . 'Gửi thử email đến ' . $__templater->escape($__vars['xf']['visitor']['email']) . '.' . '</div>
';
	}
	$__finalCompiled .= '
	...
	<div class="block-container">
		<div class="block-body">
			' . $__templater->formRow('
				...
				<a href="' . $__templater->fn('link', array('users/list', null, array('criteria' => $__vars['criteria'], ), ), true) . '">' . 'Xem danh sách đầy đủ' . '</a>
			', array(
