...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if ($__vars['hasPublicTemplates']) {
		$__compilerTemp2 .= '
					<a href="' . $__templater->fn('link', array('styles/templates', $__vars['style'], array('addon_id' => $__vars['addOn']['addon_id'], 'type' => 'public', ), ), true) . '" class="menu-linkRow">' . 'Mẫu công khai' . '</a>
				';
	}
	$__compilerTemp2 .= '
				';
	if ($__vars['hasEmailTemplates']) {
		$__compilerTemp2 .= '
					<a href="' . $__templater->fn('link', array('styles/templates', $__vars['style'], array('addon_id' => $__vars['addOn']['addon_id'], 'type' => 'email', ), ), true) . '" class="menu-linkRow">' . 'Mẫu email' . '</a>
				';
	}
	$__compilerTemp2 .= '
				';
