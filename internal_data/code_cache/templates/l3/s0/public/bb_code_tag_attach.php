...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	if (!$__vars['attachment']) {
		$__finalCompiled .= '
	<a href="' . $__templater->fn('link', array('full:attachments', array('attachment_id' => $__vars['id'], ), ), true) . '" target="_blank">' . 'Xem đính kèm ' . $__templater->escape($__vars['id']) . '' . '</a>
';
	} else if (!$__vars['attachment']['has_thumbnail']) {
		$__finalCompiled .= '
	<a href="' . $__templater->fn('link', array('full:attachments', $__vars['attachment'], array('hash' => $__vars['attachment']['temp_hash'], ), ), true) . '" target="_blank">' . 'Xem đính kèm ' . $__templater->escape($__vars['attachment']['filename']) . '' . '</a>
';
