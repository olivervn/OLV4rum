...
' . '<p>' . (((('<a href="' . $__templater->fn('link', array('canonical:members', $__vars['sender'], ), true)) . '">') . $__templater->escape($__vars['sender']['username'])) . '</a>') . ' đã trả lời cuộc trò chuyện tại ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
...
<tr>
	...
	<td align="' . ($__vars['xf']['isRtl'] ? 'left' : 'right') . '">
		<a href="' . $__templater->fn('link', array('canonical:conversations', ), true) . '" class="buttonFake">' . 'Xem tất cả cuộc trò chuyện' . '</a>
	</td>
</tr>
</table>
