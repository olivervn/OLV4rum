...
' . '<p>' . $__templater->escape($__vars['sender']['username']) . ' đã bắt đầu một cuộc trò chuyện mới với bạn tại ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
