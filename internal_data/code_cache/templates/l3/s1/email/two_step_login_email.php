...
<p>Để hoàn tất việc đăng nhập vào tài khoản của bạn (hoặc để hoàn thành thiết lập xác minh hai bước) tại ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . ', bạn phải nhập mã sau đây:</p>' . '
