...
' . '<p>' . $__templater->escape($__vars['sender']['username']) . ' đã thêm bạn vào cuộc trò chuyện tại ' . (((('<a href="' . $__templater->fn('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '
