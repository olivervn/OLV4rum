<?php
// FROM HASH: 336c5d4bb92b57662ab3ea61d1b4006f
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
		...
		$__compilerTemp1 .= '
			' . $__templater->formRow('
				<div class="block-rowMessage block-rowMessage--important block-rowMessage--small">
					<a href="' . $__templater->fn('link', array('forums/post-thread', $__vars['forum'], ), true) . '">' . 'Bạn có một bản nháp đã lưu. Nhấp vào đây để tải nó' . '</a>
				</div>
			', array(
	...
	<div class="js-quickThreadFields" data-xf-init="attachment-manager">
		...
		'title' => $__templater->filter('Hủy', array(array('for_attr', array()),), false),
		'data-xf-init' => 'tooltip',
	), '', array(
	)) . '
			</div>
