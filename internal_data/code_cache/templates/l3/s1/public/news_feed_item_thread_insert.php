...
return array('macros' => array(), 'code' => function($__templater, array $__vars)
{
	...
	' . '' . $__templater->fn('username_link', array($__vars['user'], false, array('defaultname' => $__vars['newsFeed']['username'], ), ), true) . ' đã đăng chủ đề ' . ((((('<a href="' . $__templater->fn('link', array('threads', $__vars['content'], ), true)) . '">') . $__templater->fn('prefix', array('thread', $__vars['content'], ), true)) . $__templater->escape($__vars['content']['title'])) . '</a>') . ' trong ' . (((('<a href="' . $__templater->fn('link', array('forums', $__vars['content']['Forum'], ), true)) . '">') . $__templater->escape($__vars['content']['Forum']['title'])) . '</a>') . '.' . '
</div>
