	...
	array(
		...
		<div class="block-footer">
			<ul class="listInline listInline--bullet">
				...
				<li>' . 'Tổng cảnh cáo' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->filter($__templater->fn('count', array($__vars['warnings'], ), false), array(array('number', array()),), true) . '</li>
			</ul>
		</div>
	</div>
</div>';
