...
return array('macros' => array('like_snippet' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['comment']['user_id'] == $__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '
			' . '' . $__templater->fn('username_link', array($__vars['liker'], false, array('defaultname' => $__vars['fallbackName'], ), ), true) . ' đã thích <a ' . (('href="' . $__templater->fn('link', array('profile-posts/comments', $__vars['comment'], ), true)) . '"') . '>bình luận của bạn</a> trên bài viết hồ sơ của ' . $__templater->escape($__vars['comment']['ProfilePost']['username']) . '.' . '
		';
