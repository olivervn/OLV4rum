...
'notice' => function($__templater, array $__arguments, array $__vars)
{
	...
	if ($__vars['notice']['dismissible'] AND (!$__vars['notice']['custom_dismissible'])) {
		$__finalCompiled .= '
				<a href="' . $__templater->fn('link', array('account/dismiss-notice', null, array('notice_id' => $__vars['notice']['notice_id'], ), ), true) . '" class="notice-dismiss js-noticeDismiss" data-xf-init="tooltip" title="' . $__templater->filter('Loại bỏ thông báo', array(array('for_attr', array()),), true) . '"></a>
			';
	}
	$__finalCompiled .= '
