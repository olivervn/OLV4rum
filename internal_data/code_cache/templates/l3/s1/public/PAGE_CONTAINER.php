<?php
// FROM HASH: e362f94356207dea2b4b6d874a926434
...
';
	...
	if ($__vars['xf']['visitor']['is_moderator'] AND ((!$__vars['xf']['options']['reportIntoForumId']) AND $__vars['xf']['session']['reportCounts']['total'])) {
		$__compilerTemp1 .= '
					<a href="' . $__templater->fn('link', array('reports', ), true) . '"
						...
						title="' . ($__vars['xf']['session']['reportCounts']['lastBuilt'] ? (('Cập nhật báo cáo lần cuối' . $__vars['xf']['language']['label_separator'] . ' ') . $__templater->fn('date_time', array($__vars['xf']['session']['reportCounts']['lastBuilt'], ), true)) : '') . '">
						' . 'Báo cáo' . '
					</a>
				';
	}
	...
	if ($__vars['xf']['visitor']['is_moderator'] AND (!$__vars['xf']['options']['reportIntoForumId'])) {
		$__compilerTemp2 .= '
								<a href="' . $__templater->fn('link', array('reports', ), true) . '" class="menu-linkRow" title="' . ($__vars['xf']['session']['reportCounts']['lastBuilt'] ? (('Cập nhật báo cáo lần cuối' . $__vars['xf']['language']['label_separator'] . ' ') . $__templater->fn('date_time', array($__vars['xf']['session']['reportCounts']['lastBuilt'], ), true)) : '') . '">' . 'Báo cáo' . '</a>
							';
	}
	$__compilerTemp2 .= '
							' . '
			...
			$__compilerTemp4 .= '
				...
				'href' => '',
							...
							<a href="' . $__templater->fn('link', array('conversations', ), true) . '"
								...
								<span class="p-navgroup-linkText">' . 'Tin nhắn' . '</span>
							</a>
								...
								<div class="menu-content">
									...
									<div class="menu-footer menu-footer--split">
										<span class="menu-footer-main">
											<a href="' . $__templater->fn('link', array('conversations', ), true) . '">' . 'Hiển thị tất cả' . $__vars['xf']['language']['ellipsis'] . '</a>
										</span>
							...
							<div class="menu menu--structural menu--medium" data-menu="menu" aria-hidden="true"
								...
								<div class="menu-content">
									...
									<div class="menu-footer menu-footer--split">
										<span class="menu-footer-main">
											<a href="' . $__templater->fn('link', array('account/alerts', ), true) . '">' . 'Hiển thị tất cả' . $__vars['xf']['language']['ellipsis'] . '</a>
										</span>
										<span class="menu-footer-opposite">
...
';
	...
	<div class="u-scrollButtons js-scrollButtons" data-trigger-type="' . $__templater->fn('property', array('scrollJumpButtons', ), true) . '">
		...
		if ($__templater->fn('property', array('scrollJumpButtons', ), false) != 'up') {
			$__finalCompiled .= '
			' . $__templater->button('<i class="fa fa-arrow-down"></i><span class="u-srOnly">' . 'Dưới' . '</span>', array(
				'href' => '#footer',
				'class' => 'button--scroll',
				'data-xf-click' => 'scroll-to',
			), '', array(
